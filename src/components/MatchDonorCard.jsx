          ...
          <div className="flex justify-between xl:gap-8 gap-4">
            <div>
              ...
              {reasons.map((reason, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 font-normal text-base text-[#0D1D2C] mb-2"
                >
                  <svg
                    width="15"
                    height="15"
            ...
            {donor.missing_criteria?.length > 0 && (
              <div>
                ...
                {donor.missing_criteria.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 font-normal text-base text-[#0D1D2C] mb-2"
                  >
